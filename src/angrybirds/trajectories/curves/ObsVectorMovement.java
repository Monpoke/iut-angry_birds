...
public class ObsVectorMovement extends Movement {
    ...
    /**
     * false --> l'obstacle s'eloigne de son point de départ true --> l'obstacle
     * se rapproce de son point de départ
     */
    ...
    /**
     * Valeur à partir de la quelle l'obstacle va se rapprocer de son point de
     * départ
     */
    private int max;
     ...
     *
     * @param vector Initialisation de max (entre 5 et 45)
     */
    ...
    /**
     * Calcul de la nouvelle position de l'obstacle en fonction des attributs
     * length et width du Vector2d vector
     */
    @Override
